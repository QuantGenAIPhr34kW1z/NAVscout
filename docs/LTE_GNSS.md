...
v2.3 focuses on GNSS ingest + safe uplink transport. Modem bring-up is left to system tooling.
...
NAVscout v2.3 assumes outbound connectivity exists and focuses on encrypted telemetry.
