...
- 🔴 **Battery monitoring** via MAVLink `SYS_STATUS`
- 🔴 **Thermal monitoring** from RPI5 thermal zones
- 🟡 **Link health tracking** with RTT/loss measurement
- 🟡 **Adaptive telemetry rate** based on link quality
- 🟢 **Unit tests** for GNSS parser, geofence, crypto
- 🟢 **Integration tests** for end-to-end mission scenarios
