...
impl NavEngine {
    ...
    pub fn step(&mut self, fix: GnssFix) -> NavOutput {
        ...
        let in_zone = point_in_polygon(&self.zone.garden_polygon, fix.lat, fix.lon);
        ...
        let msg = match self.state {
            ...
            MissionState::OperateInZone => "OPERATE: inside garden zone".to_string(),
